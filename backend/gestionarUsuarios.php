                ...
                <div class="form__login">
                    <div class="form-container">
                        <div class="loginEmail">
                            ...
                            <br>
                            <p>Puedes modificar el nombre, teléfono y el email del usuario.</p>
                            ...
                            <a href='gestionarUsuarios.php'>Seleccionar otro usuario</a><br><br>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td data-title="Eliminar Usuario"><button class="btn btn-green" type='submit' name='eliminar' value='<?php echo $result->id_usuario ?>'>Eliminar</button></td>
                                </tr>
                            <?php
                            }
                            ?>
